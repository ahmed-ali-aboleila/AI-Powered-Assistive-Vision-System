...
if RPI_MODE:
    ...
    FRAME_WIDTH = int(os.environ.get("VISION_FRAME_WIDTH", "424"))
    ...
    INFERENCE_ACTIVE_N = int(os.environ.get("VISION_INFERENCE_ACTIVE_N", "4"))
    INFERENCE_STABLE_N = int(os.environ.get("VISION_INFERENCE_STABLE_N", "8"))
    TTA_CONFIDENCE_THRESHOLD = float(os.environ.get("VISION_TTA_THRESHOLD", "0.40"))
    FACE_RECOGNITION_EVERY_N = _env_int("VISION_FACE_RECOGNITION_EVERY_N", 6)
    FACE_RECOGNITION_CACHE_SEC = _env_float("VISION_FACE_RECOGNITION_CACHE_SEC", 4.0)
