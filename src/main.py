...
===================================
Integrates:
  - Face Recognition  â†’ identifies known/unknown/blocked persons
  - Emotion Detection â†’ reads emotions using CNN + TTA
  - Logic Controller  â†’ decides what to say and when
  - Shared TTS        â†’ single voice output (Edge TTS neural)
...
# â”€â”€ Fix: UTF-8 output on Windows to prevent UnicodeEncodeError â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
import config
from utils.model_runtime import TFLiteEmotionModel

if getattr(config, "RPI_MODE", False):
    cv2.setNumThreads(int(os.environ.get("VISION_OPENCV_THREADS", "2")))

# â”€â”€ Load emotion model BEFORE DeepFace (critical for keras compatibility) â”€â”€â”€â”€â”€
...
# â”€â”€ Shared TTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
from voice.tts import TTS
tts = TTS(rate=config.TTS_RATE)

# â”€â”€ Face Recognition â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
from face_recognition.face_db import FaceDB
from face_recognition.face_processor import FaceProcessor
from face_recognition.registration import RegFlow
from voice.stt import STT
from utils.draw_utils import draw_text_unicode

# â”€â”€ Emotion Detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
from emotion.audio_detector import AudioEmotionDetector
from emotion.display import draw_results, draw_no_face, draw_fps

# â”€â”€ Logic Controller â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
from voice.logic_controller import LogicController
...
class AssistiveVisionSystem:
    ...
    def __init__(self):
        print("=" * 55)
        print("  Assistive Vision System â€” Starting Up")
        print("=" * 55)

        # â”€â”€ Emotion model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        print("\n[1/5] Loading emotion model...")
        self._emotion_model = _emotion_model_global
        print(f"      Model: {config.MODEL_PATH}")

        # â”€â”€ Face Recognition â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Emotion Detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        print("\n[3/5] Initializing Emotion Detection...")
        self._audio_det = AudioEmotionDetector()
        print("      Emotion Detection ready.")

        # â”€â”€ Logic Controller â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Inference thread â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Per-face emotion smoothing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Adaptive inference rate â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        print("  Say 'vision' or 'ÙÙŠØ¬Ù†' to activate voice commands.")
        print("=" * 55 + "\n")
    ...
    def _log(self, name, emotion, emo_conf, source, brightness, mode="normal"):
        if self._log_writer:
            ...
            self._log_file.flush()   # [FIX #8] flush immediately â€” no data loss on crash
    ...
    # â”€â”€ Brightness â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def _face_threshold(self, brightness: float) -> float:
        """[OPT #9] Adaptive face threshold â€” more lenient in low light."""
        if brightness < config.BRIGHTNESS_THRESHOLD:
            return getattr(config, 'FACE_THRESHOLD_LOW_LIGHT', 0.55)
        return config.FACE_THRESHOLD

    # â”€â”€ Adaptive inference interval â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def _get_inference_n(self) -> int:
        ...
        if self._stable_frames >= self._stable_threshold:
            return self._stable_n   # emotion stable â†’ less frequent
        return self._active_n       # emotion changing â†’ more frequent

    # â”€â”€ Emotion smoothing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def _smooth_emotion(self, face_id: str, raw_idx: int) -> int:
        ...
        if count / len(hist) >= stable_ratio:
            return most_common
        return raw_idx   # not stable yet â€” use raw

    def _cleanup_stale_histories(self, active_face_ids: set):
        """Remove emotion history for faces no longer in frame â€” prevents memory leak."""
        stale = [k for k in self._emotion_history if k not in active_face_ids]
        for k in stale:
            del self._emotion_history[k]

    # â”€â”€ Predict emotion (single face input) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def _predict_emotion(self, face_input: np.ndarray) -> tuple:
        """
        [OPT #2] Conditional TTA:
          - If confidence â‰¥ TTA_CONFIDENCE_THRESHOLD â†’ single fast predict
          - If confidence <  TTA_CONFIDENCE_THRESHOLD â†’ full 5-pass TTA
        """
        ...
        if float(preds.max()) >= tta_threshold:
            # High confidence â€” no TTA needed
            return preds, "fast"

        # Low confidence â€” run full TTA for better accuracy
    ...
    # â”€â”€ Inference (background thread) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def _infer_frame(self, frame, frame_gray, brightness):
        ...
        # â”€â”€ Per-face: liveness + recognition + crop â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for box in faces:
            ...
            # Recognition â€” use adaptive threshold
            ...
            # Crop face for emotion â€” collect for batch
        ...
        # â”€â”€ Batch emotion prediction [OPT #3] â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Collect all valid face inputs into one batch
        valid_indices = [i for i, fi in enumerate(face_inputs) if fi is not None]
        final_preds = {}   # â† must init here to avoid UnboundLocalError
        ...
        # â”€â”€ Assemble results â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        for i, (face_id, name, rec_score, box, area) in enumerate(face_meta):
            if i in final_preds:
                preds    = final_preds[i]
                raw_idx  = int(np.argmax(preds))
                # Minimal smoothing â€” only 3 frames, prevents flicker
    ...
    # â”€â”€ Audio Fallback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                if reg_result and reg_result != "PENDING":
                    if isinstance(reg_result, str):
                        if reg_result.startswith("registered:"):
                            ...
                            self._face_proc.reset()   # Ø§Ù…Ø³Ø­ vote buffer ÙÙˆØ±Ø§Ù‹
                        elif reg_result.startswith("blocked:"):
                            name = reg_result.replace("blocked:", "")
                            self._face_proc.reset()   # Ø§Ù…Ø³Ø­ vote buffer
                        elif reg_result.startswith("unblocked:"):
                            self._face_proc.reset()

                # â”€â”€ [OPT #5] Adaptive inference rate â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                inference_n = self._get_inference_n()
                if self._frame_count % inference_n == 0:
                    self._run_inference(frame, frame_gray, brightness)

                # â”€â”€ Apply inference result â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                with self._inference_lock:
