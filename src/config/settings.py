...
MAX_FACES_PER_FRAME = _env_int("VISION_MAX_FACES_PER_FRAME", 0)
CAMERA_READ_FAIL_LIMIT = _env_int("VISION_CAMERA_READ_FAIL_LIMIT", 8)

if RPI_MODE:
    CAMERA_INDEX = int(os.environ.get("VISION_CAMERA_INDEX", "0"))
    FRAME_WIDTH = int(os.environ.get("VISION_FRAME_WIDTH", "320"))
    FRAME_HEIGHT = int(os.environ.get("VISION_FRAME_HEIGHT", "240"))
    TARGET_FPS = int(os.environ.get("VISION_TARGET_FPS", "10"))
    SHOW_WINDOW = _env_bool("VISION_SHOW_WINDOW", False)
    USE_TFLITE_EMOTION = _env_bool("VISION_USE_TFLITE", True)
    INFERENCE_ACTIVE_N = int(os.environ.get("VISION_INFERENCE_ACTIVE_N", "6"))
    INFERENCE_STABLE_N = int(os.environ.get("VISION_INFERENCE_STABLE_N", "10"))
    TTA_CONFIDENCE_THRESHOLD = float(os.environ.get("VISION_TTA_THRESHOLD", "0.40"))
    FACE_RECOGNITION_EVERY_N = _env_int("VISION_FACE_RECOGNITION_EVERY_N", 10)
    FACE_RECOGNITION_CACHE_SEC = _env_float("VISION_FACE_RECOGNITION_CACHE_SEC", 6.0)
    MAX_FACES_PER_FRAME = _env_int("VISION_MAX_FACES_PER_FRAME", 1)
